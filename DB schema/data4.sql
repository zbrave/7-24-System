...
INSERT INTO `ban` VALUES (1,2,'Spam','2017-05-16 22:51:22','2017-05-18 22:51:22',0);
...
CREATE TABLE `complaint` (
  ...
  `response_file` mediumblob,
  `complaint_file` mediumblob,
...
INSERT INTO `complaint` VALUES (1,2,1,NULL,2,'2017-05-16 22:03:12','Fakülte girişindeki cam kırılmış.',4,'2017-05-16 22:13:45','Cam takıldı.',NULL,1,1,0,'2017-05-16 22:13:09','2017-05-16 22:10:13',NULL,NULL),(2,2,1,NULL,3,'2017-05-16 22:10:51','Bölümün arka kapısında cam kırılmış.',4,'2017-05-16 22:16:24','Cam kalmadığı için takamıyoruz.',3,1,1,0,'2017-05-16 22:13:15','2017-05-16 22:12:36',NULL,NULL),(3,1,2,2,3,'2017-05-16 22:16:24','Cam alınması gerekiyor.',5,'2017-05-16 22:44:13','10 tane cam aldım.',7,1,1,0,'2017-05-16 22:44:00','2017-05-16 22:31:05',NULL,NULL),(7,2,1,3,3,'2017-05-16 22:44:14','Bölümün arka kapısında cam kırılmış.',4,'2017-05-16 22:47:15','Cam takıldığı için ortalık dağıldı.',8,1,1,0,'2017-05-16 22:46:10','2017-05-16 22:45:39',NULL,NULL),(8,2,3,7,3,'2017-05-16 22:48:10','Yerdeki cam kırıklarının temizlenmesi gerekiyor.',6,'2017-05-16 22:58:31','Temizlendi.',NULL,1,1,0,'2017-05-16 22:58:22','2017-05-16 22:48:19',NULL,NULL),(10,1,3,NULL,2,'2017-05-16 22:49:25','Yerde cam kırıkları var2.',NULL,'2017-05-16 22:57:55','Spam.',NULL,1,0,0,'2017-05-16 22:57:55','2017-05-16 22:57:55',NULL,NULL);
...
--
-- Table structure for table `passactivation`
--

DROP TABLE IF EXISTS `passactivation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `passactivation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `code` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`,`user_id`),
  KEY `fk_passactivation_user1_idx` (`user_id`),
  CONSTRAINT `fk_passactivation_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `passactivation`
--

LOCK TABLES `passactivation` WRITE;
/*!40000 ALTER TABLE `passactivation` DISABLE KEYS */;
INSERT INTO `passactivation` VALUES (5,2,'WM83ILTU1IMP110S87');
/*!40000 ALTER TABLE `passactivation` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-05-24 13:34:10
